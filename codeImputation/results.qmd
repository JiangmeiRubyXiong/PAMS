...
+ $B$ : total number of simulations
+ $\theta$ : parameter from the true data
+ $\hat\theta^b$ : parameter from the true data in each simulation $b$
+ $\hat\theta^b_{syn}$: parameter from synthesized data
